...
public class LZDLCPFee {
    @Step("LZD file: Calculate the sum of the column amount in the LCP Fee")
    public static double sumOfLzdLCPFee(String filePath) {
        double totalSum = 0;
        double totalSum1 = 0;
        double totalSum2 = 0;
        try {
            ...
            for (Row row : sheet) {
                ...
                if (feeStr != null && feeStr.equals("LCP Fee")) {
                ...
                if (feeStr2 != null && feeStr2.equals("Reversal LCP Fee")) {
                    // Get the amount from the specified column
                    Cell amountCell = row.getCell(amountColumnIndex);
                    double amountValue = amountCell.getNumericCellValue();
                    if (amountCell != null) {
            ...
            System.out.printf("Total sum of LCP Fee + Reversal on LZD: ");
