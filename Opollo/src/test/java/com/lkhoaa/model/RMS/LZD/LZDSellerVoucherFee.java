...
public class LZDSellerVoucherFee {
    @Step("LZD file: Calculate the sum of the column amount in the Seller Voucher fee")
    public static double sumOfLzdSellerVoucherFee(String filePath) {
        double totalSum1 = 0;
        double totalSum2 = 0;
        double totalSum = 0;
        try {
            ...
            System.out.printf("Total sum of Promotional Charges Vouchers + Reversal Promotional Charges Vouchers on LZD: ");
