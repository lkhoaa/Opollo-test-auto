...
public class LZDDamageFee {
    @Step("LZD file: Calculate the sum of the column amount in the Damage Claim fee")
    public static double sumOfLzdDamageFee(String filePath) {
        double totalSum = 0;
        try {
            // Load the Excel file
            ...
            for (Row row : sheet) {
                ...
                if (feeStr != null && feeStr.equals("Damaged Claim")) {
            ...
            System.out.printf("Total sum of Damaged Claim amounts on LZD: ");
