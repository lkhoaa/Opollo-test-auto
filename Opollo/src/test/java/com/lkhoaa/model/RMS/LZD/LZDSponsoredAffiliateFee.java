...
public class LZDSponsoredAffiliateFee {
    @Step("LZD file: Calculate the sum of the column amount in the Sponsored Affiliate fee")
    public static double sumOfLzdSponsoredAffiliateFee(String filePath) {
        double totalSum = 0;
        double totalSum1 = 0;
        double totalSum2 = 0;
        try {
            ...
            for (Row row : sheet) {
                ...
                if (feeStr != null && feeStr.equals("Sponsored Affiliates")) {
                ...
                if (feeStr2 != null && feeStr2.equals("Sponsored Affiliates Refund")) {
                    // Get the amount from the specified column
                    Cell amountCell = row.getCell(amountColumnIndex);
                    double amountValue = amountCell.getNumericCellValue();
                    if (amountCell != null) {
            ...
            System.out.printf("Total sum of Sponsored Affiliates + Refund on LZD: ");
