...
public class OpolloLCPFee {
    @Step("Opollo file: Calculate the sum of the column amount in the 'LCP Fee' sheet")
    public static double sumOfOPLCPFee(String filePath) {
        ...
        try {
            ...
            System.out.printf("Total sum of LCP Fee amounts on OP: ");
