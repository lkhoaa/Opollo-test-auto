...
public class UpdateFileCreateSingleSKU {
    public void updateExcelFile(String filePath) throws IOException {
        ...
        setCellValue(row, 11, "IE"); // Column L
        ...
        setCellValue(row, 24, 333); // Column Y
        setCellValue(row, 25, 444); // Column Z
        ...
        setCellValue(row, 35, "123abc"); // Column AJ
        setCellValue(row, 36, "Normal"); // Column AK
        setCellValue(row, 37, "pickup_by_buyer"); // Column AL
