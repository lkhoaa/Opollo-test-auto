...
public class LZDLzdcoinDiscountFee {
    @Step("LZD file: Calculate the sum of the column amount in the Lzdcoin Discount fee")
    public static double sumOfLzdLzdcoinDiscountFee(String filePath) {
        double totalSum = 0;
        double totalSum1 = 0;
        double totalSum2 = 0;
        try {
            ...
            for (Row row : sheet) {
                ...
                if (feeStr != null && feeStr.equals("Lazcoin discount")) {
                ...
                if (feeStr2 != null && feeStr2.equals("Reversal Lazcoin discount")) {
                    // Get the amount from the specified column
                    Cell amountCell = row.getCell(amountColumnIndex);
                    double amountValue = amountCell.getNumericCellValue();
                    if (amountCell != null) {
            ...
            System.out.printf("Total sum of Lazcoin Discount + Reversal Lazcoin Discount on LZD: ");
