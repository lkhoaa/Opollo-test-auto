...
import com.lkhoaa.model.pms.UpdateFileEditVirtualBundleSKU;
...
public class MassUpdateVirtualBundleSKU {
    @Test
    public void massUpdateVirtualBundleSKU() throws IOException, InterruptedException {
        String filePath = System.getProperty("user.dir") + "/src/test/data/pms/virtual_bundle_import_update_template_v4.xlsx";
        UpdateFileEditVirtualBundleSKU updateFileEditVirtualBundleSKU = new UpdateFileEditVirtualBundleSKU();
        updateFileEditVirtualBundleSKU.updateExcelFile(filePath);
